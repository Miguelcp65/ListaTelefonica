...
class DBHelper(context: Context) : SQLiteOpenHelper(context, "database.db", null, 1) {
    ...
    private val sql = arrayOf(
        ...
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('Maria', 'Address Maria', 'maria@gmail.pt', 911233211, -1)",
        "INSERT INTO contact (name, address, email, phone, imageId) VALUES ('Joao', 'Address Joao',  'joao@gmail.pt', 911233212, -1)"
    )
